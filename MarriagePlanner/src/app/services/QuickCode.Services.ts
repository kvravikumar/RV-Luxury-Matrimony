...
export class QuickCodeService {
    ...
    GetByType(Category: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetByType/'+Category, "", httpOptions);
     }
     GetByTypeSugg(Category: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetByTypeSugg/'+Category, "", httpOptions);
     }
     GetByTypeWithRemarks(codetype: string,remarks: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetByTypeWithRemarks/'+codetype + "/" +remarks, "", httpOptions);
     }
    
     GetRoleAll(searchtxt: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetRoleAll/'+searchtxt, "", httpOptions);
     }

     GetApprTypeRole(apprtype: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetApprTypeRole/'+apprtype, "", httpOptions);
     }
     GetVerticalAll(searchtxt: string) {
        // debugger;
        const httpOptions = { headers: this.headerSettings };
         return this.http.post<any>(this.Url + 'GetVerticalAll/'+searchtxt, "", httpOptions);
     }
